package com.redscarf.admin.common.servlet;
...
import com.redscarf.admin.common.utils.FileUtils;
...
@WebServlet(urlPatterns = "/static/ckfinder/core/connector/java/connector.java", initParams = {
        ...
        @WebInitParam(name = "configuration", value = "com.redscarf.admin.common.web.CKFinderConfig")
}, loadOnStartup = 1)
