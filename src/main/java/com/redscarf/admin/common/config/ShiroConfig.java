...
import com.redscarf.admin.common.security.shiro.session.CacheSessionDAO;
import com.redscarf.admin.common.security.shiro.session.SessionManager;
import com.redscarf.admin.modules.sys.security.FormAuthenticationFilter;
import com.redscarf.admin.modules.sys.security.SystemAuthorizingRealm;
...
public class ShiroConfig {
    ...
    public SessionManager sessionManager(CacheSessionDAO dao) {
        ...
        sessionManager.setSessionIdCookie(new SimpleCookie("admin.session.id"));
